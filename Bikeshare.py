...
def get_filters():
    ...
    while month not in ['all', 'january', 'february', 'march', 'april', 'may', 'june']:
        month = input("Sorry, that's not one of the options, please input a month from January to June. Alternatively type 'all' to exclude month filter\n")
    # get user input for day of week (all, monday, tuesday, ... sunday)
    
    day = input("Please input day of week: ").lower()
    
    while day not in ['all', 'monday', 'tuesday', 'wednesday','thursday', 'friday', 'saturday', 'sunday']:
        day = input("Sorry, that seems invalid, please type a day of the week in full, alternatively type 'all'.")
